<%-- 
    Document   : sub-fac
    Created on : 21 Mar, 2017, 2:02:09 AM
    Author     : Mayank Jain
--%>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="logout.jsp"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
        ...
        <div class="container">
            <h2>Faculty-subject Registration</h2>
            <div class="col-sm-8">
                <form class="form-horizontal" action="SaveSyllabus" method="POST" enctype="multipart/form-data">
