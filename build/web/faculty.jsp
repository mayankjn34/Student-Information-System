<%-- 
    Document   : faculty
    Created on : 21 Mar, 2017, 2:18:55 PM
    Author     : Mayank Jain
--%>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="logout.jsp"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
        ...
        <div class="container">
            ...
            <div class="col-sm-8">
            <form class="form-horizontal" action="SaveFaculty" method="POST">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2">Highest Qualification:</label>
                <div class="col-sm-10">
