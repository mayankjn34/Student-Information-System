...
while(r.next()){
      ...
      out.write("          <tr>\n");
      out.write("              <td>");
      out.print(r.getString("roll"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("fname"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("lname"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("gender"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getDate("dob"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("address"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("ftname"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("email"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("contact"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("course"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getInt("tenth"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("twelth"));
      out.write("</td>\n");
      out.write("              <td>");
      out.print(r.getString("catagory"));
      out.write("</td>\n");
      out.write("          </tr>\n");
      out.write("          ");
}
      out.write("\n");
      out.write("      </table>\n");
      out.write("      <h2>Delete Student detail</h2>\n");
      out.write("      <form class=\"form-horizontal\" action=\"DeleteStudent\" method=\"POST\">\n");
